 ...
 * 4 1.
 * - The third bank is chosen, and the same thing happens: 2 4 1 2. At this point, we've reached a state we've seen
 * before: 2 4 1 2 was already seen. The infinite loop is detected after the fifth block redistribution cycle, and so
...
function redistribute(array &$a): int
{
    $patterns = [];
    $steps    = 0;
...
echo 'test steps: ' . redistribute($test1) . PHP_EOL;
echo 'input steps: ' . redistribute($input) . PHP_EOL;
